# Contributing to pkg-rpm-sigma-dut
...
1. [Fork](https://github.com/qualcomm-linux/pkg-template/fork) and clone the repository.
    ...
    ```bash
    git clone https://github.com/qualcomm-linux/pkg-rpm-sigma-dut.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/pkg-rpm-sigma-dut.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/pkg-rpm-sigma-dut/pulls) from your branch to `main`.
